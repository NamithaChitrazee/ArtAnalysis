...
std::vector<float> fTensor_sequential1dense31MatMulGemm60 = std::vector<float>(1);
float * tensor_sequential1dense31MatMulGemm60 = fTensor_sequential1dense31MatMulGemm60.data();
std::vector<float> fTensor_sequential1dense1MatMulGemm70 = std::vector<float>(5);
float * tensor_sequential1dense1MatMulGemm70 = fTensor_sequential1dense1MatMulGemm70.data();
std::vector<float> fTensor_sequential1dense1BiasAddReadVariableOp0bcast = std::vector<float>(5);
...
//--- broadcast bias tensor sequential1dense1BiasAddReadVariableOp0for Gemm op
   {
      float * data = TMVA::Experimental::SOFIE::UTILITY::UnidirectionalBroadcast<float>(tensor_sequential1dense1BiasAddReadVariableOp0,{ 5 }, { 1 , 5 });
      std::copy(data, data + 5, tensor_sequential1dense1BiasAddReadVariableOp0bcast);
      delete [] data;
   }
//--- broadcast bias tensor sequential1dense12BiasAddReadVariableOp0for Gemm op
   {
      float * data = TMVA::Experimental::SOFIE::UTILITY::UnidirectionalBroadcast<float>(tensor_sequential1dense12BiasAddReadVariableOp0,{ 10 }, { 1 , 10 });
      std::copy(data, data + 10, tensor_sequential1dense12BiasAddReadVariableOp0bcast);
      delete [] data;
   }
//--- broadcast bias tensor sequential1dense21BiasAddReadVariableOp0for Gemm op
   {
      float * data = TMVA::Experimental::SOFIE::UTILITY::UnidirectionalBroadcast<float>(tensor_sequential1dense21BiasAddReadVariableOp0,{ 5 }, { 1 , 5 });
      std::copy(data, data + 5, tensor_sequential1dense21BiasAddReadVariableOp0bcast);
      delete [] data;
   }
//--- broadcast bias tensor sequential1dense31AddReadVariableOp0for Gemm op
   {
      float * data = TMVA::Experimental::SOFIE::UTILITY::UnidirectionalBroadcast<float>(tensor_sequential1dense31AddReadVariableOp0,{ 1 }, { 1 , 1 });
      std::copy(data, data + 1, tensor_sequential1dense31AddReadVariableOp0bcast);
      delete [] data;
   }
}
...
//--------- Gemm
   ...
   int op_2_lda = 5;
   int op_2_ldb = 10;
   std::copy(tensor_sequential1dense12BiasAddReadVariableOp0bcast, tensor_sequential1dense12BiasAddReadVariableOp0bcast + 10, tensor_sequential1dense12MatMulGemm80);
...
//--------- Gemm
   ...
   int op_4_lda = 10;
   int op_4_ldb = 5;
   std::copy(tensor_sequential1dense21BiasAddReadVariableOp0bcast, tensor_sequential1dense21BiasAddReadVariableOp0bcast + 5, tensor_sequential1dense21MatMulGemm90);
...
//--------- Gemm
   ...
   int op_6_lda = 5;
   int op_6_ldb = 1;
   std::copy(tensor_sequential1dense31AddReadVariableOp0bcast, tensor_sequential1dense31AddReadVariableOp0bcast + 1, tensor_sequential1dense31MatMulGemm60);
